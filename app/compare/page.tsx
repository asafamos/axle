...
const tools: Tool[] = [
  {
    ...
    reports: "Sticky PR comment + JSON + Markdown + public /r/<id> shareable URL + Claude-generated remediation patterns",
    artifacts: "Per-PR scan history, EU multilingual statement pack (10 languages), Hebrew תקנה 35, VPAT-grade evidence",
    price: "Free 1 repo · $49/mo Team · $299/mo Business",
    bestFor: "Continuous compliance for teams that ship to EAA / ADA / Section 508 markets — see /why-axle for the honest ROI math",
  },
  {
    name: "Pa11y",
    url: "https://pa11y.org",
